    ...
    <Dialog open={open}>
      ...
      <DialogContent className="sm:max-w-[503px] rounded-sm p-2 z-50"
       >
        ...
        <DialogDescription className="text-center font-normal text-modal-content text-md leading-tight px-10"
          dangerouslySetInnerHTML={{ __html: message }} 
        />
        <p className="text-center font-normal text-modal-content text-md leading-tight">Do you still want to continue?</p>

        <DialogFooter className="flex justify-center my-3 gap-5 sm:justify-center">
          <Button
            type="button"
            variant="outline"
            onClick={onCancel}
