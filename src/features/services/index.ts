...
export { Scope1TableSection } from './components/scope1/scope1-table-section';
...
export { Scope2TableSection } from './components/scope2/scope2-table-section';
...
export { Scope3TableSection } from './components/scope3/scope3-table-section';
