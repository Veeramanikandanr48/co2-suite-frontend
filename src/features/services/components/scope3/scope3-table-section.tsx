...
import { Scope3TableSectionProps } from '@/types/components/services.types';
...
export function Scope3TableSection({
  category,
  totalCount,
  isLoading,
  isNotRelevant,
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-neutral-50 p-3 rounded-lg border border-neutral-200">
          ...
          <button
            onClick={() => {
              ...
              setAdditionalFilter({ category: config.categoryTag });
              refetch();
            }}
