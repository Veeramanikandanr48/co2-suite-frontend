...
import { EditInventoryModal, InventoryItem as EditModalItem } from '@/features/services/components/shared/edit-inventory-modal';
import { Scope1TableSectionProps } from '@/types/components/services.types';
import { createInventoryColumns } from '../shared/inventory-table-columns';

export function Scope1TableSection({
  category,
  totalCount,
  isLoading,
  activityNotRelevant,
  ...
  return (
    <>
      <div className={`bg-white border border-neutral-200 rounded-xl p-5 shadow-sm space-y-4 ${activityNotRelevant ? 'opacity-40 pointer-events-none select-none' : ''}`}>
